    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="{{ Request::is('*companies') ? 'active' : ''}} nav-item"><a class="nav-link" href="{{ route('companies.index') }}">
                        <i class="ft-home"></i><span>Companies</span> <i class="fa fa-angle-down"></i></a>
                </li>

                <li class="{{ Request::is('*groups') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="fa fa-users"></i><span class="menu-title" data-i18n="">Groups</span></a>
                </li>

                <li class="{{ Request::is('*roles') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="ft-user"></i><span class="menu-title" data-i18n="">Roles</span></a>
                </li>

                <li class="{{ Request::is('*users') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="ft-users"></i><span class="menu-title" data-i18n="">Users</span></a>
                </li>

                <li class="{{ Request::is('*clients') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="fa fa-handshake-o"></i><span class="menu-title" data-i18n="">Clients</span></a>
                </li>

                <li class="{{ Request::is('*contacts') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="fa fa-address-book-o"></i><span class="menu-title" data-i18n="">Contacts</span></a>
                </li>

                <li class="{{ Request::is('*loans') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="fa fa-money"></i><span class="menu-title" data-i18n="">Loans</span></a>
                </li>

                <li class="{{ Request::is('*leads') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="fa fa-tty menu-icon"></i><span class="menu-title" data-i18n="">Leads</span></a>
                </li>

                <li class="{{ Request::is('*settings') ? 'active' : ''}} nav-item"><a class="nav-link" href="">
                        <i class="fa fa-handshake-o"></i><span class="menu-title" data-i18n="">Settings</span></a>
                </li>
